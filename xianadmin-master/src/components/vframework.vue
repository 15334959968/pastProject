        ...
        <el-main>
            <section>
                ...
                <el-col :span="24" class="" style="padding-bottom: 0px;">
                    <el-form :inline="true" >
                        <el-form-item >
                            <el-input v-model="selectResult.searchParamMap['name']" placeholder="组织名称" ></el-input>
                        </el-form-item>
                        <el-form-item >
                ...
                <el-table :data="selectResult.paging.list" highlight-current-row v-loading="listLoading" style="width: 100%;"  max-height="600">
                    ...
                    <!--</el-table-column>-->
                    <el-table-column prop="type1" label="单位类型" width="120" >
                    </el-table-column>
                    <el-table-column prop="type2" label="所属单位" width="120" >
                    </el-table-column>
                    <el-table-column prop="type3" label="所属部门" width="120" >
                    </el-table-column>
                    <el-table-column prop="type4" label="角色名称" width="120" >
                    </el-table-column>
                    <el-table-column prop="remark" label="组织描述" width="320" >
                    </el-table-column>
                ...
                <el-dialog :title="dialogTitle" width="200"  :visible.sync="FormVisible" :close-on-click-modal="false" :show-close="false" :close-on-press-escape="false" append-to-body >
                    <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                        ...
                        <el-form-item label="单位类型" >
                            <el-select v-model="editForm.type1" placeholder="请选择">
                                <el-option
                        ...
                        <el-form-item label="所属单位" >
                            <el-select v-model="editForm.type2" placeholder="请选择">
                                <el-option
                        ...
                        <el-form-item label="所属部门" >
                            <el-select v-model="editForm.type3" placeholder="请选择">
                                <el-option
                        ...
                        <el-form-item label="角色名称" >
                            <el-select v-model="editForm.type4" placeholder="请选择">
                                <el-option
        ...
        methods: {
            ...
            editSubmit () {
                ...
                if(!_this.checkfomr(_this.editForm)){
                    ...
                    _this.alert("请输入创建的组织名称");
                }else if(!_this.editForm.remark){
                    _this.alert("请输入创建的组织描述");
                }else{
                    let ps={
