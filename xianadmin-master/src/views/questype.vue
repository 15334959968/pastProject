    ...
    <el-container>
        <el-main>
            <section class="all-size">
                ...
                <el-row>
                    <el-col :span="24">
                        <el-table :data="questatus" highlight-current-row v-loading="listLoading" :fit="true" style="width: 100%;" max-height="700" >
                            <el-table-column type="selection" min-width="30"> </el-table-column>
                            <el-table-column prop="id" min-width="30"> </el-table-column>
                            <el-table-column prop="title" label="分类名称" min-width="50"> </el-table-column>
