        ...
        <el-main>
            <section>
                ...
                <el-table :data="selectResult.paging.list" highlight-current-row v-loading="listLoading" style="width: 100%;"  max-height="600">
                    ...
                    <el-table-column prop="name" :label="keytitle+'名称'" width="150" >
                    </el-table-column>
                    <el-table-column prop="remark" :label="keytitle+'描述'" width="320" >
                    </el-table-column>
        ...
        methods: {
            ...
            getList(){
                ...
                _this.selectResult.paging.list=Array(10).fill({
                    ...
                    createname: ["紧急", "一般"][parseInt(Math.random(3) * 3)],
                    remark: '紧急度描述信息',
                })
