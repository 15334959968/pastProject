    ...
    <el-container>
        <el-main>
            <section>
                ...
                <!--新增界面-->
                <el-dialog title="部门管理" :visible.sync="addFormVisible" :before-close="handleClose" append-to-body >
                        ...
                        <el-row>
                            <el-col :span="12">
                                <el-form-item label="用户类型">
                                    <el-select v-model="addForm.userType1" placeholder="请选择" style="width: 90%">
                                        <el-option
                                                v-for="item in userType"
                                                :key="item.value"
                                                :label="item"
                            ...
                            <el-col :span="12">
                                <el-form-item label="所属单位">
                                    <el-select v-model="addForm.companiesName" placeholder="请选择" style="width: 90%">
                                        <el-option
    ...
    export default {
        ...
        methods: {
            ...
            getProperty(){
                ...
                this.$servers.getPropertyList(option).then(
                        (res) =>{
                    let s=res.type;
            ...
            addSubmit(){
                ...
                let option ={
                    ...
                    companies:para.companies1,
                    remark:para.remark,
                    title:para.title,
                    userType:para.userType1
                };
                this.$servers.addProperty(option).then(res=>{
                    this.$message(res);
            ...
            editSubmit: function () {
                this.$refs.editForm.validate((valid) => {
                    if (valid) {
                        ...
                        this.$servers.editPropertyList(option).then(res=>{
                            this.$message(res);
            ...
            handleDel(id){
                console.log(id);
                this.$servers.deleteProperty({ id })
                        .then(data => {
                    this.$message(data);
            ...
            find(){
                ...
                console.log(option)
                this.$servers.queryPropertyList(option).then((res)=>{
